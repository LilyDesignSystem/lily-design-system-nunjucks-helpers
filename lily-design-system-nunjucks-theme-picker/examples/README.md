...
`theme-picker-list`, `theme-picker-option`. `data-lily-*`
...
[`themePickerCustom.njk`](./themePickerCustom.njk) is a thin wrapper
around `../theme-picker.njk` that bakes in a house glyph via a
