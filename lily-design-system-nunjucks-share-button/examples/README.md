# ShareButton examples

Each file is a self-contained Nunjucks template fragment. They assume
`share-button.njk` is resolvable by your environment's loader and that
`share-button.client.js` is served somewhere the browser can import it.
