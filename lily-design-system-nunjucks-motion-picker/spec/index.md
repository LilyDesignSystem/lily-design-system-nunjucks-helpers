...
two-bar pause SVG icon (`viewBox="0 0 16 16"`, replaceable via a
`{% call %}` block), and a `<ul class="motion-picker-list"
...
2026-09-16 from a Unicode glyph). It is additive:
...
- **2026-09-16**: default icon changed from the Unicode glyph U+23F8
  PAUSE SIGN + U+FE0E (exported as `PAUSE_SIGN`) to a bundled outline
  SVG. Maintainer-directed, applied to all five page-header pickers
  the same day. The glyph constant was removed, not renamed.
